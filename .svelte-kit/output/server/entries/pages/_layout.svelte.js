...
const logo = "/_app/immutable/assets/svelte-logo.HE0FFa4J.svg";
const github = "/_app/immutable/assets/github.uzgWIyxm.svg";
const css$1 = {
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<div class="app svelte-8o1gnw">${validate_component(Header, "Header").$$render($$result, {}, {}, {})} <main class="svelte-8o1gnw">${slots.default ? slots.default({}) : ``}</main> <footer class="svelte-8o1gnw" data-svelte-h="svelte-ha2vls"><p>made with ❤ by<a href="https://jessejesse.com" class="svelte-8o1gnw"> Jesse</a></p></footer> </div>`;
});
export {
  Layout as default
};
