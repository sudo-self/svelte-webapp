...
export declare class Env implements IStoreValue {
...
export declare interface RefBase extends Finalizer, RefTracker {
}

export declare class RefBase extends Finalizer {
...
export declare class Reference extends RefBase implements IStoreValue {
    id: number;
    private canBeWeak;
